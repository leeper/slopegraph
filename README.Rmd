...
```{r cancer-survival, fig.show='hide', fig.path='inst/examples/', fig.height = 12, fig.width = 10, dev='svglite', cache=TRUE}
library("slopegraph")
data(cancer)
...
```{r gdp, fig.show='hide', fig.path='inst/examples/', fig.height = 12, fig.width = 10, dev='svglite', cache=TRUE}
data(gdp)
slopegraph(gdp, col.lines = 'gray', labels = c('1970','1979'),  
...
```{r states, fig.show='hide', fig.path='inst/examples/', fig.height = 15, fig.width = 15, dev='svglite', cache=TRUE}
data(states)
...
```{r ggstates, fig.show='hide', fig.path='inst/examples/', fig.height = 15, fig.width = 15, dev='svglite', cache=TRUE}
data(states)
cols <- `[<-`(rep("black", 37), 7, "red")
