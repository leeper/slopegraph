...
```{r cancer-survival, results='hide', fig.path='inst/examples/', fig.height = 12, fig.width = 10, dev='svglite', cache=TRUE}
library("slopegraph")
data(cancer)
...
![Cancer Survival](https://raw.githubusercontent.com/leeper/slopegraph/master/inst/examples/cancer-survival-1.svg)
...
```{r gdp, results='hide', fig.path='inst/examples/', fig.height = 12, fig.width = 10, dev='svglite', cache=TRUE}
data(gdp)
...
![GDP](https://raw.githubusercontent.com/leeper/slopegraph/master/inst/examples/gdp-1.svg)
...
```{r states, results='hide', fig.path='inst/examples/', fig.height = 15, fig.width = 15, dev='svglite', cache=TRUE}
data(states)
slopegraph(states, ylim = c(37,0), offset.x = 0.06,
           main = 'Relative Rank of U.S. State Populations, 1790-1870')
```

![states](https://raw.githubusercontent.com/leeper/slopegraph/master/inst/examples/states-1.svg)
